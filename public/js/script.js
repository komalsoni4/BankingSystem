...
function sendMoney(){
    ...
    var findSenderBankAccount = enterSName ;   // sender aur receiver account ke id ko set kro yrr
    var enterSAmount = parseInt(document.getElementById(findSenderBankAccount).innerHTML);
    if (enterAmount > enterSAmount){
        alert("Insufficient Balance!")
    }
    else{
        var findUserBankAccount = enterName ;   // sender aur receiver account ke id ko set kro yrr
